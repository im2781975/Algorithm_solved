...
{
    int i = 0, j = 0;
    // vector to store the intersection of the arr1[] and arr2[]
    while (i < m && j < n) {
...
int main()
{
    ...
    // temp array to store the common elements of arr1 and arr2 arrays
    int temp[200000];
    // ans array to store the common elements of temp and arr3 arrays (i.e common elements of all 3 arrays)
    int ans[200000];
