...
#include <cstdlib>
using namespace std;
// ar1[0..m-1] and ar2[0..n-1] are two given sorted arrays and x is given number. prints the pair from both arrays such that the sum of the pair is closest to x.
