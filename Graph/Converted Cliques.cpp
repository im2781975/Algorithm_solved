...
// function returns true if subgraph reachable from src is Bipartite or not.
...
bool isBipartite(int G[][V])
{
    ...
    // vertex 'i'.  The value 1 is used to indicate first color is assigned and value 0 indicates
