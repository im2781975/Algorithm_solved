...
// utility function to print the shortest distance between src vertex and dst vertex
void printShortestDistance(vector<int> adj[], int s, int dest, int v)
{
    // predecessor[i] array stores predecessor of i and distance array stores distance of i
    // from s
    int pred[v], dist[v];
...
int main()
{
    ...
    // add_edge function takes adjacency list, source and destination vertex as argument and forms
