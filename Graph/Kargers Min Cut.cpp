...
// a structure to represent a connected, undirected & unweighted graph as a collection of edges.
struct Graph
{
    int V, E;
...
//Please note that Karger's algorithm is a Monte Carlo Randomized algo
