//reverse a doubly linked list in groups of given size without recursion Iterative Method
#include <iostream>
using namespace std;
...
Node* revListInGroupOfGivenSize(Node* head, int k)
{
    ...
    while (st) {
        ...
        if (!globprev)
            ...
            prev->prev
                = globprev;
                // connecting last node of last k group to the first node of present k group
            globprev = st;
        }
