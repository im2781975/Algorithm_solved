// find minimum number of dice throws required to reach last cell from first cell of a given snake and ladder board
#include <iostream>
#include <queue>
using namespace std;
...
// returns minimum number of dice throws required to Reach last cell from 0'th cell in a snake and ladder game.
// move[] is an array of size N where N is no.of cells on board If there is no snake or ladder from cell i, 
// then move[i] is -1 Otherwise move[i] contains cell to which snake or ladder at i takes to.
